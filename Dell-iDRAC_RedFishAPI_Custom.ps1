...
function Install-Certificate
{
    ...
    Write-VenafiDebug -Message "Converting the PKCS12 certificate representation byte array to Base64 encoded format"

    $base64Str = [System.Convert]::ToBase64String($p12)
    ...
    try {
        ...
        $Rep_Post = Invoke-WebRequest -UseBasicParsing -Uri $LienPOST -Method Post -Body $body -ContentType 'application/json' -Headers $headers -ErrorVariable RespErr
